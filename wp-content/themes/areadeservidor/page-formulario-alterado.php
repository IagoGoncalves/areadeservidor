<?php
/**
 * Template Name: formulario-alterado
 *
...
?>
	...
	<main id="formulario-alterado" class="formulario-alterado" tabindex="-1" role="main">
<div class="container">
			...
			<form class="caixa-transporte col-md-12" method="post">
				...
				<div class="input-label mensagem">
					<textarea class="mensagem" type="text" name="mensagem" size=230 maxlength=230 placeholder=" Texto limitado a 230 caracteres, com espaço." required></textarea>
				</div>
			</form>
			...
			<form class="caixa-recursos col-md-12" method="post">
				<div class="titulo-caixas">
					<h2>PREENCHER OS CAMPOS ABAIXO CASO TENHA UTILIZADO<br>RECURSOS DE ADIANTAMENTO DE VIAGEM</h2>
				</div>
			...
			<form class="caixa-avaliacao col-md-12" method="post">
				<div class="titulo-caixas">
					<h2>AVALIAÇÃO DO CURSO / TREINAMENTO / EVENTO</h2>
				</div>
				<div class="input-label">
  					<label>O curso atingiu os objetivos propostos?</label>
				...
				<div class="input-label">
  					<label>A carga horário estava compativel com o conteúdo?</label>
  						<input class="sim" type="checkbox" name="alimentacao" value="alimentacao"><span>Sim</span> 
  						<input class="nao" type="checkbox" name="alimentacao" value="alimentacao"><span>Não</span> 
  						
				</div>
				<div class="input-label">
  					<label>Os exemplos adotados foram coerentes com a teoria?</label>
  						<input class="sim" type="checkbox" name="alimentacao" value="alimentacao"><span>Sim</span> 
  						<input class="nao" type="checkbox" name="alimentacao" value="alimentacao"><span>Não</span> 
  						
				</div>
				<div class="input-label">
  					<label>As instalações eram adequadas? (inclusive os recursos visuais adotados)</label>
  						<input class="sim" type="checkbox" name="alimentacao" value="alimentacao"><span>Sim</span> 
  						<input class="nao" type="checkbox" name="alimentacao" value="alimentacao"><span>Não</span> 
  						
				</div>
				<div class="input-label mensagem">
					<label for="nome">Se não responda o por que?</label>
